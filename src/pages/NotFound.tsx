    ...
    return (
        <div className="flex items-center justify-center h-screen bg-background">
            <div className="text-center">
                <p className="text-custom-blue text-8xl text-text font-bold mb-4">404</p>
                <h1 className="text-6xl font-semibold text-text mb-4">Page Not Found</h1>
                <p className="text-custom-gray text-xl mb-8 text-text" >We can't find the page you're looking for.</p>
